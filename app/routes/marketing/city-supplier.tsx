...
export default function SupplierPage() {
  ...
  const data = getCityBySlugOnly(city || "");
  if (!data) notFound();
  ...
  const jsonLd = [
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: `${data.city} Suppliers`, item: `https://bulkgreencoffee.com/${city || ""}-green-coffee-supplier` },
      ],
    },
    {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "@id": `https://bulkgreencoffee.com/${city || ""}-green-coffee-supplier`,
      ...
      url: `https://bulkgreencoffee.com/${city || ""}-green-coffee-supplier`,
